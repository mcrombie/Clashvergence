...
greater_virginia_territory_map = {
    # Virginia
    "Northern Virginia": {"neighbors": ["Shenandoah Valley", "Central Virginia", "Washington, D.C.", "Maryland"], "owner": None, "armies": 0},
    "Shenandoah Valley": {"neighbors": ["Northern Virginia", "Central Virginia", "Southwestern Virginia", "West Virginia"], "owner": None, "armies": 0},
    "Tidewater": {"neighbors": ["Central Virginia", "Southside", "Delaware"], "owner": None, "armies": 0},
    ...
    "Outer Banks": {"neighbors": ["Coastal Plain"], "owner": None, "armies": 0},
